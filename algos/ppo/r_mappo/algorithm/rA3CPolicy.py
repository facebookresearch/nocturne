...
class R_A3CPolicy:
    """
    A3C Policy  class. Wraps actor and critic networks to compute actions and value function predictions.
    ...
    Edit: No more shared observation space since each actor/critic will only draw from their respective
    environment.
    """
