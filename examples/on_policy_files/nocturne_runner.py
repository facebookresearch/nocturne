...
from algos.ppo.base_runner import Runner as PPORunner
from algos.a3c.base_runner import Runner as A3CRunner
...
def getNocturneRunner(Runner):
    ...
    class NocturneSharedRunner(Runner):
        ...
        def collect(self, step):
            ...
            if self.cfg['algorithm_name'] == "a3c":
...
def main(cfg):
    ...
    runner = getNocturneRunner(Runner)
